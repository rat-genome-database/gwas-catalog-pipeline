...
public class DAO {
    ...
    public int getNextRatGwasSeq() throws Exception {
        return dao.getNextKeyFromSequence("GWAS_CAT_SEQ");
    }
    public int insertGWASBatchWOSeq(Collection<GWASCatalog> toBeInserted) throws Exception{
